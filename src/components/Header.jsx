...
import { FaShoppingCart, FaChevronDown, FaTimes, FaChevronRight } from 'react-icons/fa';
          ...
          <div className="mobile-menu-container">
            ...
            <div className="mobile-menu-content">
              <ul className="mobile-menu-nav">
                ...
                <li>
                  <button 
                    className="mobile-menu-link w-100 text-start d-flex justify-content-between align-items-center"
                    onClick={() => setShowMobileCategories(!showMobileCategories)}
                  >
                    Categorías
                    <FaChevronRight 
                      style={{
                        transform: showMobileCategories ? 'rotate(90deg)' : 'none',
              ...
              {estaLogueado ? (
                <button 
                  ...
                  className="mobile-menu-admin text-center w-100 mb-3"
                >
                  cerrar sesión
                </button>
              ) : (
